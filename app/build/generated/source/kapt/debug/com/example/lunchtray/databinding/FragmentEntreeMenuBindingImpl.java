...
public class FragmentEntreeMenuBindingImpl extends FragmentEntreeMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.entree == variableId) {
            setEntree((com.example.lunchtray.ui.order.EntreeMenuFragment) variable);
        }
    ...
    public void setEntree(@Nullable com.example.lunchtray.ui.order.EntreeMenuFragment Entree) {
        this.mEntree = Entree;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.entree);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.EntreeMenuFragment entree = mEntree;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 6: {
                ...
                com.example.lunchtray.ui.order.EntreeMenuFragment entree = mEntree;
                // entree != null
                boolean entreeJavaLangObjectNull = false;



                entreeJavaLangObjectNull = (entree) != (null);
                if (entreeJavaLangObjectNull) {


                    entree.goToNextScreen();
                }
                break;
            }
            case 3: {
