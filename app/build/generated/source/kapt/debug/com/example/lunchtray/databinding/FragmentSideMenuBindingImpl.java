...
public class FragmentSideMenuBindingImpl extends FragmentSideMenuBinding implements com.example.lunchtray.generated.callback.OnClickListener.Listener {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.sideDish == variableId) {
            setSideDish((com.example.lunchtray.ui.order.SideMenuFragment) variable);
        }
    ...
    public void setSideDish(@Nullable com.example.lunchtray.ui.order.SideMenuFragment SideDish) {
        this.mSideDish = SideDish;
        synchronized(this) {
            mDirtyFlags |= 0x2L;
        }
        notifyPropertyChanged(BR.sideDish);
        super.requestRebind();
    }
    ...
    protected void executeBindings() {
        ...
        com.example.lunchtray.ui.order.SideMenuFragment sideDish = mSideDish;
    ...
    public final void _internalCallbackOnClick(int sourceId , android.view.View callbackArg_0) {
        switch(sourceId) {
            ...
            case 5: {
                // localize variables for thread safety
                // sideDish != null
                boolean sideDishJavaLangObjectNull = false;
                // sideDish
                com.example.lunchtray.ui.order.SideMenuFragment sideDish = mSideDish;



                sideDishJavaLangObjectNull = (sideDish) != (null);
                if (sideDishJavaLangObjectNull) {


                    sideDish.cancelOrder();
                }
                break;
            }
            case 2: {
